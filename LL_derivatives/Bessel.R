#L0
L0=function(rho, alpha, M, Nsum=NULL){
...
DalpL0=function(rho, alpha, M, Nsum=NULL){
...
D2alpL0=function(rho, alpha, M, Nsum=NULL){
...
DrhoL0=function(rho, alpha, M, Nsum=NULL){
...
D2rhoL0=function(rho, alpha, M, Nsum=NULL){
...
DalpDrhoL0=function(rho, alpha, M, Nsum=NULL){
...
D2alpInteg = function(rho, alpha, Nsum=NULL){
